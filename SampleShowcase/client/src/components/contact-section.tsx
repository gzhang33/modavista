      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-text-grey max-w-2xl mx-auto">
            Ready to explore our collection? Contact our wholesale team for detailed catalogs, pricing, and sample requests.
          </p>
        </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h5 className="font-semibold text-charcoal mb-1">Manufacturing Facility</h5>
                    <p className="text-text-grey">
                      1285 Industrial Boulevard<br />
                      Milan, Italy 20154
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h5 className="font-semibold text-charcoal mb-1">Wholesale Sales</h5>
                    <p className="text-text-grey">
                      +39 02 1234 5678<br />
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-text-grey">
                      wholesale@ateliertextile.com<br />
                      samples@ateliertextile.com
                    </p>
                  </div>
                </div>
              </div>
            ...
            <Card className="bg-charcoal text-white border-none">
              <CardContent className="p-6">
                <h5 className="text-xl font-playfair font-semibold mb-4">Minimum Order Requirements</h5>
                <ul className="space-y-2 text-sm">
                  <li>• Minimum order: 100 pieces per style</li>
                  <li>• Sample orders: 5-10 pieces available</li>
                  <li>• Lead time: 4-6 weeks for production</li>
