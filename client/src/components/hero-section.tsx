    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
        ...
        <h2 className="text-5xl md:text-7xl font-playfair font-bold mb-6 leading-tight drop-shadow-lg">
          {t('home.hero.title', 'Premium Wholesale Garment Collection')}
        </h2>
        <p className="text-xl md:text-2xl mb-8 font-light max-w-2xl mx-auto leading-relaxed drop-shadow-md">
          {t('home.hero.subtitle', 'Discover our curated selection of high-quality garments crafted for discerning wholesale partners')}
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          >
            {t('home.hero.explore', 'Explore Collections')}
          </Button>
          <Button
          ...
          >
            {t('home.hero.samples', 'Request Samples')}
          </Button>
        </div>
      </div>
    </section>
